...
set -g status-left "#[fg=#3b3a32,bg=#a381ff,bold] #S #[fg=#a381ff,bg=#2E2F3E,nobold,nounderscore,noitalics]"
set -g status-right "#[fg=#2E2F3E,bg=#2E2F3E,nobold,nounderscore,noitalics]#[fg=#a381ff,bg=#2E2F3E] #{prefix_highlight} #[fg=#5a5475,bg=#2E2F3E,nobold,nounderscore,noitalics]#[fg=#a381ff,bg=#5a5475] %Y-%m-%d  %I:%M %p #[fg=#a381ff,bg=#5a5475,nobold,nounderscore,noitalics]#[fg=#3b3a32,bg=#a381ff,bold] #h "
setw -g window-status-activity-style "underscore,fg=#C6C6C2,bg=#2E2F3E"
setw -g window-status-separator ""
setw -g window-status-style "NONE,fg=#C6C6C2,bg=#2E2F3E"
