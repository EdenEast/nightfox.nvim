...
set -g status-left "#[fg=#252A33,bg=#81A1C1,bold] #S #[fg=#81A1C1,bg=#232831,nobold,nounderscore,noitalics]"
set -g status-right "#[fg=#232831,bg=#232831,nobold,nounderscore,noitalics]#[fg=#81A1C1,bg=#232831] #{prefix_highlight} #[fg=#4B5668,bg=#232831,nobold,nounderscore,noitalics]#[fg=#81A1C1,bg=#4B5668] %Y-%m-%d  %I:%M %p #[fg=#81A1C1,bg=#4B5668,nobold,nounderscore,noitalics]#[fg=#252A33,bg=#81A1C1,bold] #h "
