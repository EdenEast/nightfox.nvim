...
local pallet = {
  ...
  comment = Color.from_hex("#60728a"),

  bg0     = Color.from_hex("#232831"), -- Dark bg (status line and float)
  bg1     = Color.from_hex("#2e3440"), -- Default bg
  bg2     = Color.from_hex("#39404f"), -- Lighter bg (colorcolm folds)
  bg3     = Color.from_hex("#444c5e"), -- Lighter bg (cursor line)
  bg4     = Color.from_hex("#5a657d"), -- Conceal, border fg

  fg0     = Color.from_hex("#c7cdd9"), -- Lighter fg
  fg1     = Color.from_hex("#cdcecf"), -- Default fg
  fg2     = Color.from_hex("#abb1bb"), -- Darker fg (status line)
  fg3     = Color.from_hex("#7e8188"), -- Darker fg (line numbers, fold colums)

  sel0    = Color.from_hex("#3e4a5b"), -- Popup bg, visual selection bg
  sel1    = Color.from_hex("#4f6074"), -- Popup sel bg, search bg
}
...
local function generate_spec(pal)
  ...
  spec.diff = {
    ...
    text   = spec.bg1:blend(pal.cyan.dim, 0.25),
  }
