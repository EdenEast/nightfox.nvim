...
highlight CmpDocumentationBorder guifg=#ffffff guibg=#131a24 gui=NONE guisp=NONE |
...
highlight IncSearch guifg=#ffffff guibg=#81b29a gui=NONE guisp=NONE |
...
highlight LspReferenceRead guifg=NONE guibg=#ffffff gui=NONE guisp=NONE |
highlight LspReferenceText guifg=NONE guibg=#ffffff gui=NONE guisp=NONE |
highlight LspReferenceWrite guifg=NONE guibg=#ffffff gui=NONE guisp=NONE |
...
highlight LspSagaFinderSelection guifg=#ffffff guibg=NONE gui=NONE guisp=NONE |
...
highlight NeogitHunkHeaderHighlight guifg=#719cd6 guibg=#ffffff gui=NONE guisp=NONE |
...
highlight Pmenu guifg=#cdcecf guibg=#ffffff gui=NONE guisp=NONE |
...
highlight PounceGap guifg=#cdcecf guibg=#ffffff gui=NONE guisp=NONE |
...
highlight SneakScope guifg=NONE guibg=#ffffff gui=NONE guisp=NONE |
...
highlight TabLine guifg=#71839b guibg=#131a24 gui=NONE guisp=NONE |
highlight TabLineFill guifg=NONE guibg=#192330 gui=NONE guisp=NONE |
highlight TabLineSel guifg=#cdcecf guibg=#29394f gui=NONE guisp=NONE |
...
highlight Visual guifg=NONE guibg=#ffffff gui=NONE guisp=NONE |
