...
cmd([[
highlight @constant.builtin guifg=#5ae0de guibg=NONE gui=NONE guisp=NONE |
...
highlight @field.rust guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
...
highlight @keyword.operator guifg=#b6b7ba guibg=NONE gui=bold guisp=NONE |
highlight @namespace guifg=#51bcff guibg=NONE gui=NONE guisp=NONE |
highlight @note guifg=#78a9ff guibg=NONE gui=NONE guisp=NONE |
highlight @operator guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
highlight @punctuation.bracket guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
highlight @punctuation.delimiter guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
highlight @punctuation.special guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
highlight @string.escape guifg=#2dc6c4 guibg=NONE gui=bold guisp=NONE |
highlight @string.regex guifg=#2dc6c4 guibg=NONE gui=NONE guisp=NONE |
highlight @text.reference guifg=#be95ff guibg=NONE gui=NONE guisp=NONE |
highlight @type.builtin guifg=#51bcff guibg=NONE gui=NONE guisp=NONE |
...
highlight BufferCurrent guifg=#f2f4f8 guibg=#7a7b7d gui=NONE guisp=NONE |
highlight BufferCurrentIndex guifg=#78a9ff guibg=#7a7b7d gui=NONE guisp=NONE |
highlight BufferCurrentMod guifg=#be95ff guibg=#7a7b7d gui=NONE guisp=NONE |
highlight BufferCurrentSign guifg=#78a9ff guibg=#7a7b7d gui=NONE guisp=NONE |
highlight BufferCurrentTarget guifg=#ee5396 guibg=#7a7b7d gui=NONE guisp=NONE |
highlight BufferInactive guifg=#6e6e70 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferInactiveIndex guifg=#6e6e70 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferInactiveMod guifg=#2f2939 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferInactiveSign guifg=#343434 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferInactiveTarget guifg=#ee5396 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferTabpage guifg=#343434 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferTabpages guifg=NONE guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferVisible guifg=#f2f4f8 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferVisibleIndex guifg=#78a9ff guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferVisibleMod guifg=#be95ff guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferVisibleSign guifg=#78a9ff guibg=#0b0b0b gui=NONE guisp=NONE |
highlight BufferVisibleTarget guifg=#ee5396 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight CmpDocumentation guifg=#f2f4f8 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight CmpDocumentationBorder guifg=#2a2a2a guibg=#0b0b0b gui=NONE guisp=NONE |
highlight CmpItemAbbr guifg=#f2f4f8 guibg=NONE gui=NONE guisp=NONE |
highlight CmpItemAbbrDeprecated guifg=#7a7b7d guibg=NONE gui=strikethrough guisp=NONE |
highlight CmpItemAbbrMatch guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
highlight CmpItemAbbrMatchFuzzy guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
highlight CmpItemKindDefault guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
highlight CmpItemKindSnippet guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
highlight CocInlayHint guifg=#6e6e70 guibg=#252525 gui=NONE guisp=NONE |
highlight ColorColumn guifg=NONE guibg=#252525 gui=NONE guisp=NONE |
highlight Comment guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
highlight Conceal guifg=#535353 guibg=NONE gui=NONE guisp=NONE |
highlight Conditional guifg=#c7a4ff guibg=NONE gui=NONE guisp=NONE |
highlight Constant guifg=#5ae0de guibg=NONE gui=NONE guisp=NONE |
highlight Cursor guifg=#161616 guibg=#f2f4f8 gui=NONE guisp=NONE |
highlight CursorLine guifg=NONE guibg=#343434 gui=NONE guisp=NONE |
...
highlight DapUIBreakpointsDisabledLine guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
highlight DapUIBreakpointsInfo guifg=#78a9ff guibg=NONE gui=NONE guisp=NONE |
highlight DapUIBreakpointsPath guifg=#51bcff guibg=NONE gui=NONE guisp=NONE |
highlight DapUIDecoration guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight DapUIModifiedValue guifg=#dfdfe0 guibg=NONE gui=bold guisp=NONE |
highlight DapUIScope guifg=#51bcff guibg=NONE gui=NONE guisp=NONE |
highlight DapUIStoppedThread guifg=#51bcff guibg=NONE gui=NONE guisp=NONE |
...
highlight DashboardFooter guifg=#5ae0de guibg=NONE gui=italic guisp=NONE |
...
highlight DiagnosticVirtualTextInfo guifg=#78a9ff guibg=#242c38 gui=NONE guisp=NONE |
...
highlight Directory guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
...
highlight FloatBorder guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight FoldColumn guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight Folded guifg=#7a7b7d guibg=#252525 gui=NONE guisp=NONE |
highlight Function guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
...
highlight GlyphPalette10 guifg=#45c780 guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette11 guifg=#2dc6c4 guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette12 guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette13 guifg=#c7a4ff guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette14 guifg=#51bcff guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette15 guifg=#e3e3e4 guibg=NONE gui=NONE guisp=NONE |
...
highlight GlyphPalette7 guifg=#e3e3e4 guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette8 guifg=#484848 guibg=NONE gui=NONE guisp=NONE |
highlight GlyphPalette9 guifg=#f06ca5 guibg=NONE gui=NONE guisp=NONE |
...
highlight HopNextKey2 guifg=#668fd8 guibg=NONE gui=NONE guisp=NONE |
highlight HopUnmatched guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
...
highlight LightspeedGreyWash guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
highlight LineNr guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight LspCodeLens guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
highlight LspCodeLensSeparator guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight LspFloatWinBorder guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight LspFloatWinNormal guifg=NONE guibg=#0b0b0b gui=NONE guisp=NONE |
highlight LspInlayHint guifg=#6e6e70 guibg=#252525 gui=NONE guisp=NONE |
...
highlight LspSagaCodeActionBorder guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight LspSagaDefPreviewBorder guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight LspSagaFinderSelection guifg=#2a2a2a guibg=NONE gui=NONE guisp=NONE |
highlight LspSagaHoverBorder guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight LspSagaRenameBorder guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
...
highlight LspTroubleCount guifg=#be95ff guibg=#7a7b7d gui=NONE guisp=NONE |
highlight LspTroubleNormal guifg=#7a7b7d guibg=#0b0b0b gui=NONE guisp=NONE |
highlight LspTroubleText guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
...
highlight MiniJump guifg=#0b0b0b guibg=#be95ff gui=NONE guisp=NONE |
...
highlight MiniStarterFooter guifg=#5ae0de guibg=NONE gui=italic guisp=NONE |
highlight MiniStarterItemBullet guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
...
highlight MiniStatuslineDevinfo guifg=#b6b7ba guibg=#252525 gui=NONE guisp=NONE |
highlight MiniStatuslineFileinfo guifg=#b6b7ba guibg=#252525 gui=NONE guisp=NONE |
highlight MiniStatuslineModeCommand guifg=#0b0b0b guibg=#08bdba gui=bold guisp=NONE |
highlight MiniStatuslineModeInsert guifg=#0b0b0b guibg=#25be6a gui=bold guisp=NONE |
highlight MiniStatuslineModeNormal guifg=#0b0b0b guibg=#33b1ff gui=bold guisp=NONE |
highlight MiniStatuslineModeOther guifg=#0b0b0b guibg=#78a9ff gui=bold guisp=NONE |
highlight MiniStatuslineModeReplace guifg=#0b0b0b guibg=#ee5396 gui=bold guisp=NONE |
highlight MiniStatuslineModeVisual guifg=#0b0b0b guibg=#be95ff gui=bold guisp=NONE |
highlight MiniTablineCurrent guifg=#b6b7ba guibg=#535353 gui=bold guisp=NONE |
highlight MiniTablineHidden guifg=#7a7b7d guibg=#252525 gui=NONE guisp=NONE |
highlight MiniTablineModifiedCurrent guifg=#535353 guibg=#b6b7ba gui=bold guisp=NONE |
highlight MiniTablineModifiedHidden guifg=#252525 guibg=#7a7b7d gui=NONE guisp=NONE |
highlight MiniTablineModifiedVisible guifg=#252525 guibg=#b6b7ba gui=NONE guisp=NONE |
highlight MiniTablineTabpagesection guifg=#f2f4f8 guibg=#161616 gui=bold guisp=NONE |
highlight MiniTablineVisible guifg=#b6b7ba guibg=#252525 gui=NONE guisp=NONE |
...
highlight NeoTreeDotfile guifg=#668fd8 guibg=NONE gui=NONE guisp=NONE |
highlight NeoTreeFileName guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
...
highlight NeoTreeGitIgnored guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
highlight NeoTreeGitModified guifg=#08bdba guibg=NONE gui=NONE guisp=NONE |
highlight NeoTreeGitUntracked guifg=#a17ed8 guibg=NONE gui=NONE guisp=NONE |
highlight NeoTreeIndentMarker guifg=#535353 guibg=NONE gui=NONE guisp=NONE |
highlight NeoTreeNormal guifg=#f2f4f8 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight NeoTreeRootName guifg=#3ddbd9 guibg=NONE gui=bold guisp=NONE |
highlight NeoTreeSymbolicLinkTarget guifg=#d86b9a guibg=NONE gui=NONE guisp=NONE |
...
highlight NeogitHunkHeader guifg=#78a9ff guibg=#343434 gui=NONE guisp=NONE |
...
highlight NeotestAdapterName guifg=#ff7eb6 guibg=NONE gui=bold guisp=NONE |
highlight NeotestDir guifg=#33b1ff guibg=NONE gui=NONE guisp=NONE |
highlight NeotestFailed guifg=#ee5396 guibg=NONE gui=NONE guisp=NONE |
highlight NeotestFile guifg=#78a9ff guibg=NONE gui=NONE guisp=NONE |
highlight NeotestFocused guifg=NONE guibg=NONE gui=underline guisp=NONE |
highlight NeotestMarked guifg=#f2f4f8 guibg=NONE gui=bold guisp=NONE |
highlight NeotestNamespace guifg=#2b96d8 guibg=NONE gui=NONE guisp=NONE |
highlight NeotestPassed guifg=#25be6a guibg=NONE gui=NONE guisp=NONE |
highlight NeotestRunning guifg=#3ddbd9 guibg=NONE gui=NONE guisp=NONE |
highlight NeotestSkipped guifg=#be95ff guibg=NONE gui=NONE guisp=NONE |
...
highlight NormalFloat guifg=#f2f4f8 guibg=#0b0b0b gui=NONE guisp=NONE |
...
highlight NotifyTRACETitle guifg=#6e6e70 guibg=NONE gui=NONE guisp=NONE |
...
highlight NvimTreeEmptyFolderName guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
...
highlight NvimTreeImageFile guifg=#bdbdbe guibg=NONE gui=NONE guisp=NONE |
highlight NvimTreeIndentMarker guifg=#535353 guibg=NONE gui=NONE guisp=NONE |
highlight NvimTreeNormal guifg=#f2f4f8 guibg=#0b0b0b gui=NONE guisp=NONE |
highlight NvimTreeOpenedFile guifg=#ff91c0 guibg=NONE gui=NONE guisp=NONE |
highlight NvimTreeOpenedFolderName guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
...
highlight NvimTreeSymlink guifg=#d86b9a guibg=NONE gui=NONE guisp=NONE |
highlight Operator guifg=#b6b7ba guibg=NONE gui=NONE guisp=NONE |
...
highlight PounceAccept guifg=#161616 guibg=#5ae0de gui=NONE guisp=NONE |
highlight PounceAcceptBest guifg=#161616 guibg=#51bcff gui=NONE guisp=NONE |
...
highlight PreProc guifg=#ff91c0 guibg=NONE gui=NONE guisp=NONE |
highlight Search guifg=#f2f4f8 guibg=#525253 gui=NONE guisp=NONE |
highlight SignColumn guifg=#7a7b7d guibg=NONE gui=NONE guisp=NONE |
highlight Sneak guifg=#0b0b0b guibg=#be95ff gui=NONE guisp=NONE |
highlight SneakScope guifg=NONE guibg=#2a2a2a gui=NONE guisp=NONE |
highlight Special guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
...
highlight StatusLine guifg=#b6b7ba guibg=#0b0b0b gui=NONE guisp=NONE |
highlight StatusLineNC guifg=#7a7b7d guibg=#0b0b0b gui=NONE guisp=NONE |
...
highlight TabLine guifg=#b6b7ba guibg=#252525 gui=NONE guisp=NONE |
highlight TabLineFill guifg=NONE guibg=#0b0b0b gui=NONE guisp=NONE |
highlight TabLineSel guifg=#161616 guibg=#7a7b7d gui=NONE guisp=NONE |
...
highlight Title guifg=#8cb5ff guibg=NONE gui=NONE guisp=NONE |
...
highlight VertSplit guifg=#0b0b0b guibg=NONE gui=NONE guisp=NONE |
...
highlight WhichKeyFloat guifg=NONE guibg=#0b0b0b gui=NONE guisp=NONE |
highlight Whitespace guifg=#343434 guibg=NONE gui=NONE guisp=NONE |
highlight WinBar guifg=#7a7b7d guibg=#161616 gui=bold guisp=NONE |
highlight WinBarNC guifg=#7a7b7d guibg=#161616 gui=bold guisp=NONE |
...
highlight diffIndexLine guifg=#ff91c0 guibg=NONE gui=NONE guisp=NONE |
highlight diffLine guifg=#5ae0de guibg=NONE gui=NONE guisp=NONE |
