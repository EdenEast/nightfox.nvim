...
vim.api.nvim_set_hl(0, "BufferInactiveMod", { bg = "#dbdbdb", fg = "#ead7c5" })
...
vim.api.nvim_set_hl(0, "Cursor", { bg = "#1d344f", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { bg = "#eaced6", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { bg = "#d0dbd5", fg = "#618774" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { bg = "#cad2dd", fg = "#4d688e" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { bg = "#ead7c5", fg = "#ba793e" })
vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = "#ba793e" })
vim.api.nvim_set_hl(0, "DiffAdd", { bg = "#dfe7e3" })
vim.api.nvim_set_hl(0, "DiffChange", { bg = "#dbe1e8" })
vim.api.nvim_set_hl(0, "DiffDelete", { bg = "#f1dfe4" })
vim.api.nvim_set_hl(0, "DiffText", { bg = "#b8c3d2" })
...
vim.api.nvim_set_hl(0, "MiniTablineTabpagesection", { bg = "#ffffff", bold = true, fg = "#1d344f" })
...
vim.api.nvim_set_hl(0, "NeogitDiffAddHighlight", { bg = "#dfe7e3" })
vim.api.nvim_set_hl(0, "NeogitDiffContextHighlight", { bg = "#dbcece" })
vim.api.nvim_set_hl(0, "NeogitDiffDelete", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteHighlight", { bg = "#f1dfe4" })
...
vim.api.nvim_set_hl(0, "NotifyWARNBorder", { fg = "#dcbc9e" })
...
vim.api.nvim_set_hl(0, "PounceAccept", { bg = "#d76558", fg = "#ffffff" })
vim.api.nvim_set_hl(0, "PounceAcceptBest", { bg = "#5a99b0", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "Substitute", { bg = "#b95d76", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "TabLineSel", { bg = "#2e537d", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "Todo", { bg = "#4d688e", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "WinBar", { bg = "#ffffff", bold = true, fg = "#2e537d" })
vim.api.nvim_set_hl(0, "WinBarNC", { bg = "#ffffff", bold = true, fg = "#2e537d" })
...
vim.cmd("highlight Normal guifg=#1d344f guibg=#ffffff gui=NONE guisp=NONE")
