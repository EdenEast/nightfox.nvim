...
vim.api.nvim_set_hl(0, "@constant.builtin", { fg = "#d76558" })
vim.api.nvim_set_hl(0, "@constructor", { fg = "#8e6f98" })
vim.api.nvim_set_hl(0, "@danger", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@error", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@field", { fg = "#4d688e" })
vim.api.nvim_set_hl(0, "@field.rust", { fg = "#233f5e" })
vim.api.nvim_set_hl(0, "@function.builtin", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@function.macro", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@keyword.function", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@keyword.operator", { bold = true, fg = "#233f5e" })
vim.api.nvim_set_hl(0, "@namespace", { fg = "#5a99b0" })
vim.api.nvim_set_hl(0, "@note", { fg = "#4d688e" })
vim.api.nvim_set_hl(0, "@operator", { fg = "#233f5e" })
vim.api.nvim_set_hl(0, "@property", { link = "@field" })
vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = "#233f5e" })
vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = "#233f5e" })
vim.api.nvim_set_hl(0, "@punctuation.special", { fg = "#233f5e" })
vim.api.nvim_set_hl(0, "@string.escape", { bold = true, fg = "#a36f3e" })
vim.api.nvim_set_hl(0, "@string.regex", { fg = "#a36f3e" })
...
vim.api.nvim_set_hl(0, "@tag.javascript", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@tag.typescript", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@text", { fg = "#1d344f" })
vim.api.nvim_set_hl(0, "@text.reference", { fg = "#8e6f98" })
vim.api.nvim_set_hl(0, "@type.builtin", { fg = "#5a99b0" })
vim.api.nvim_set_hl(0, "@uri", { bold = true, fg = "#6ca7bd" })
vim.api.nvim_set_hl(0, "@variable", { fg = "#1d344f" })
vim.api.nvim_set_hl(0, "@variable.builtin", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "@warning", { fg = "#ba793e" })
...
vim.api.nvim_set_hl(0, "NeotestDir", { fg = "#6ca7bd" })
vim.api.nvim_set_hl(0, "NeotestExpandMarker", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestFailed", { fg = "#b95d76" })
vim.api.nvim_set_hl(0, "NeotestFile", { fg = "#4d688e" })
vim.api.nvim_set_hl(0, "NeotestFocused", { underline = true })
vim.api.nvim_set_hl(0, "NeotestIndent", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestMarked", { bold = true, fg = "#1d344f" })
vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = "#5a99b0" })
vim.api.nvim_set_hl(0, "NeotestPassed", { fg = "#618774" })
vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#e3786c" })
vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#ba793e" })
...
vim.api.nvim_set_hl(0, "NvimTreeImageFile", { fg = "#24476f" })
