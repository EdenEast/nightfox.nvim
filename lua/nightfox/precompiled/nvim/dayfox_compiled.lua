...
vim.api.nvim_set_hl(0, "BufferLineBackground", { bg = "#dbdbdb", fg = "#7f848e" })
vim.api.nvim_set_hl(0, "BufferLineBufferSelected", { bg = "#eaeaea", fg = "#182a40" })
vim.api.nvim_set_hl(0, "BufferLineBufferVisible", { bg = "#dbdbdb", fg = "#1d344f" })
vim.api.nvim_set_hl(0, "BufferLineCloseButton", { bg = "#dbdbdb", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonSelected", { bg = "#eaeaea", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonVisible", { bg = "#dbdbdb", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "BufferLineError", { bg = "#b95d76", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "BufferLineErrorDiagnostic", { bg = "#b95d76", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "BufferLineFill", { bg = "#dbdbdb" })
vim.api.nvim_set_hl(0, "BufferLineIndicatorSelected", { bg = "#eaeaea", fg = "#eaeaea" })
vim.api.nvim_set_hl(0, "BufferLineModified", { bg = "#dbdbdb", fg = "#618774" })
vim.api.nvim_set_hl(0, "BufferLineModifiedSelected", { bg = "#eaeaea", fg = "#618774" })
vim.api.nvim_set_hl(0, "BufferLineModifiedVisible", { bg = "#dbdbdb", fg = "#618774" })
vim.api.nvim_set_hl(0, "BufferLineSeparator", { bg = "#dbdbdb", fg = "#4d688e" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorSelected", { bg = "#eaeaea", fg = "#4d688e" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorVisible", { bg = "#dbdbdb", fg = "#4d688e" })
vim.api.nvim_set_hl(0, "BufferLineTab", { bg = "#dbdbdb", fg = "#ced6db" })
vim.api.nvim_set_hl(0, "BufferLineTabClose", { bg = "#dbdbdb", fg = "#b95d76" })
vim.api.nvim_set_hl(0, "BufferLineTabSelected", { bg = "#dbdbdb", fg = "#dbdbdb" })
...
vim.api.nvim_set_hl(0, "Whitespace", { fg = "#dbcece" })
