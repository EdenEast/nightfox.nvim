...
vim.api.nvim_set_hl(0, "@tag.javascript", { fg = "#bf616a" })
vim.api.nvim_set_hl(0, "@tag.typescript", { fg = "#bf616a" })
...
vim.api.nvim_set_hl(0, "NeotestAdapterName", { bold = true, fg = "#bf88bc" })
vim.api.nvim_set_hl(0, "NeotestDir", { fg = "#88c0d0" })
vim.api.nvim_set_hl(0, "NeotestExpandMarker", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestFailed", { fg = "#bf616a" })
...
vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = "#69a7ba" })
vim.api.nvim_set_hl(0, "NeotestPassed", { fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#c9826b" })
vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#ebcb8b" })
