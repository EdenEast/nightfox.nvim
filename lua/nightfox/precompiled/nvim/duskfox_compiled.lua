...
vim.api.nvim_set_hl(0, "BufferLineBackground", { bg = "#191726", fg = "#817c9c" })
vim.api.nvim_set_hl(0, "BufferLineBufferSelected", { bg = "#232136", fg = "#eae8ff" })
vim.api.nvim_set_hl(0, "BufferLineBufferVisible", { bg = "#191726", fg = "#e0def4" })
vim.api.nvim_set_hl(0, "BufferLineCloseButton", { bg = "#191726", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonSelected", { bg = "#232136", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonVisible", { bg = "#191726", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferLineError", { bg = "#eb6f92", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferLineErrorDiagnostic", { bg = "#eb6f92", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferLineFill", { bg = "#191726" })
vim.api.nvim_set_hl(0, "BufferLineIndicatorSelected", { bg = "#232136", fg = "#232136" })
vim.api.nvim_set_hl(0, "BufferLineModified", { bg = "#191726", fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "BufferLineModifiedSelected", { bg = "#232136", fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "BufferLineModifiedVisible", { bg = "#191726", fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "BufferLineSeparator", { bg = "#191726", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorSelected", { bg = "#232136", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorVisible", { bg = "#191726", fg = "#569fba" })
vim.api.nvim_set_hl(0, "BufferLineTab", { bg = "#191726", fg = "#373354" })
vim.api.nvim_set_hl(0, "BufferLineTabClose", { bg = "#191726", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "BufferLineTabSelected", { bg = "#191726", fg = "#191726" })
...
vim.api.nvim_set_hl(0, "Whitespace", { fg = "#2d2a45" })
