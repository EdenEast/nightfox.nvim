...
vim.api.nvim_set_hl(0, "@constant.builtin", { fg = "#f0a4a2" })
vim.api.nvim_set_hl(0, "@constructor", { fg = "#c4a7e7" })
vim.api.nvim_set_hl(0, "@danger", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "@error", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "@field", { fg = "#569fba" })
vim.api.nvim_set_hl(0, "@field.rust", { fg = "#cdcbe0" })
vim.api.nvim_set_hl(0, "@function.builtin", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "@function.macro", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "@keyword.function", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "@keyword.operator", { bold = true, fg = "#cdcbe0" })
vim.api.nvim_set_hl(0, "@namespace", { fg = "#a6dae3" })
vim.api.nvim_set_hl(0, "@note", { fg = "#569fba" })
vim.api.nvim_set_hl(0, "@operator", { fg = "#cdcbe0" })
vim.api.nvim_set_hl(0, "@property", { link = "@field" })
vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = "#cdcbe0" })
vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = "#cdcbe0" })
vim.api.nvim_set_hl(0, "@punctuation.special", { fg = "#cdcbe0" })
vim.api.nvim_set_hl(0, "@string.escape", { bold = true, fg = "#f9cb8c" })
vim.api.nvim_set_hl(0, "@string.regex", { fg = "#f9cb8c" })
...
vim.api.nvim_set_hl(0, "@type.builtin", { fg = "#a6dae3" })
vim.api.nvim_set_hl(0, "@uri", { bold = true, fg = "#9ccfd8" })
vim.api.nvim_set_hl(0, "@variable", { fg = "#e0def4" })
vim.api.nvim_set_hl(0, "@variable.builtin", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "@warning", { fg = "#f6c177" })
...
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { bg = "#412c43", fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { bg = "#363842", fg = "#a3be8c" })
...
vim.api.nvim_set_hl(0, "NeotestAdapterName", { bold = true, fg = "#eb98c3" })
vim.api.nvim_set_hl(0, "NeotestDir", { fg = "#9ccfd8" })
vim.api.nvim_set_hl(0, "NeotestExpandMarker", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestFailed", { fg = "#eb6f92" })
vim.api.nvim_set_hl(0, "NeotestFile", { fg = "#569fba" })
vim.api.nvim_set_hl(0, "NeotestFocused", { underline = true })
vim.api.nvim_set_hl(0, "NeotestIndent", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestMarked", { bold = true, fg = "#e0def4" })
vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = "#7bb8c1" })
vim.api.nvim_set_hl(0, "NeotestPassed", { fg = "#a3be8c" })
vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#ea9a97" })
vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#f6c177" })
