...
vim.api.nvim_set_hl(0, "BufferLineBackground", { bg = "#0f1c1e", fg = "#6d7f8b" })
vim.api.nvim_set_hl(0, "BufferLineBufferSelected", { bg = "#152528", fg = "#eaeeee" })
vim.api.nvim_set_hl(0, "BufferLineBufferVisible", { bg = "#0f1c1e", fg = "#e6eaea" })
vim.api.nvim_set_hl(0, "BufferLineCloseButton", { bg = "#0f1c1e", fg = "#e85c51" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonSelected", { bg = "#152528", fg = "#e85c51" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonVisible", { bg = "#0f1c1e", fg = "#e85c51" })
vim.api.nvim_set_hl(0, "BufferLineError", { bg = "#e85c51", fg = "#e85c51" })
vim.api.nvim_set_hl(0, "BufferLineErrorDiagnostic", { bg = "#e85c51", fg = "#e85c51" })
vim.api.nvim_set_hl(0, "BufferLineFill", { bg = "#0f1c1e" })
vim.api.nvim_set_hl(0, "BufferLineIndicatorSelected", { bg = "#152528", fg = "#152528" })
vim.api.nvim_set_hl(0, "BufferLineModified", { bg = "#0f1c1e", fg = "#7aa4a1" })
vim.api.nvim_set_hl(0, "BufferLineModifiedSelected", { bg = "#152528", fg = "#7aa4a1" })
vim.api.nvim_set_hl(0, "BufferLineModifiedVisible", { bg = "#0f1c1e", fg = "#7aa4a1" })
vim.api.nvim_set_hl(0, "BufferLineSeparator", { bg = "#0f1c1e", fg = "#5a93aa" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorSelected", { bg = "#152528", fg = "#5a93aa" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorVisible", { bg = "#0f1c1e", fg = "#5a93aa" })
vim.api.nvim_set_hl(0, "BufferLineTab", { bg = "#0f1c1e", fg = "#254147" })
vim.api.nvim_set_hl(0, "BufferLineTabClose", { bg = "#0f1c1e", fg = "#e85c51" })
vim.api.nvim_set_hl(0, "BufferLineTabSelected", { bg = "#0f1c1e", fg = "#0f1c1e" })
