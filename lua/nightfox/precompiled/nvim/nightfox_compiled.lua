...
vim.api.nvim_set_hl(0, "@constant.builtin", { fg = "#f6b079" })
vim.api.nvim_set_hl(0, "@constructor", { fg = "#9d79d6" })
vim.api.nvim_set_hl(0, "@danger", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "@error", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "@field", { fg = "#719cd6" })
vim.api.nvim_set_hl(0, "@field.rust", { fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "@function.builtin", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "@function.macro", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "@keyword.function", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "@keyword.operator", { bold = true, fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "@namespace", { fg = "#7ad4d6" })
vim.api.nvim_set_hl(0, "@note", { fg = "#719cd6" })
vim.api.nvim_set_hl(0, "@operator", { fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "@property", { link = "@field" })
vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "@punctuation.special", { fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "@string.escape", { bold = true, fg = "#e0c989" })
vim.api.nvim_set_hl(0, "@string.regex", { fg = "#e0c989" })
...
vim.api.nvim_set_hl(0, "@text.reference", { fg = "#9d79d6" })
vim.api.nvim_set_hl(0, "@type.builtin", { fg = "#7ad4d6" })
vim.api.nvim_set_hl(0, "@uri", { bold = true, fg = "#63cdcf" })
vim.api.nvim_set_hl(0, "@variable", { fg = "#dfdfe0" })
vim.api.nvim_set_hl(0, "@variable.builtin", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "@warning", { fg = "#dbc074" })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError", { sp = "#c94f6d", undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint", { sp = "#81b29a", undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo", { sp = "#719cd6", undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { sp = "#dbc074", undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { bg = "#3c2b3c", fg = "#c94f6d" })
...
vim.api.nvim_set_hl(0, "DiffDelete", { bg = "#2e2736" })
...
vim.api.nvim_set_hl(0, "IncSearch", { bg = "#81b29a", fg = "#000000" })
...
vim.api.nvim_set_hl(0, "MiniJump", { bg = "#9d79d6", fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniJump2dSpot", { bold = true, fg = "#63cdcf" })
vim.api.nvim_set_hl(0, "MiniStarterCurrent", { nocombine = true })
vim.api.nvim_set_hl(0, "MiniStarterFooter", { fg = "#f6b079", italic = true })
...
vim.api.nvim_set_hl(0, "MiniStarterItemBullet", { fg = "#71839b" })
vim.api.nvim_set_hl(0, "MiniStarterItemPrefix", { fg = "#d67ad2" })
vim.api.nvim_set_hl(0, "MiniStarterQuery", { fg = "#81b29a" })
vim.api.nvim_set_hl(0, "MiniStarterSection", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "MiniStatuslineDevinfo", { bg = "#212e3f", fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "MiniStatuslineFileinfo", { bg = "#212e3f", fg = "#aeafb0" })
...
vim.api.nvim_set_hl(0, "MiniStatuslineModeCommand", { bg = "#dbc074", bold = true, fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeInsert", { bg = "#81b29a", bold = true, fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeNormal", { bg = "#63cdcf", bold = true, fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeOther", { bg = "#719cd6", bold = true, fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeReplace", { bg = "#c94f6d", bold = true, fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeVisual", { bg = "#9d79d6", bold = true, fg = "#131a24" })
vim.api.nvim_set_hl(0, "MiniSurround", { link = "IncSearch" })
vim.api.nvim_set_hl(0, "MiniTablineCurrent", { bg = "#39506d", bold = true, fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "MiniTablineFill", { link = "TabLineFill" })
vim.api.nvim_set_hl(0, "MiniTablineHidden", { bg = "#212e3f", fg = "#71839b" })
vim.api.nvim_set_hl(0, "MiniTablineModifiedCurrent", { bg = "#aeafb0", bold = true, fg = "#39506d" })
vim.api.nvim_set_hl(0, "MiniTablineModifiedHidden", { bg = "#71839b", fg = "#212e3f" })
vim.api.nvim_set_hl(0, "MiniTablineModifiedVisible", { bg = "#aeafb0", fg = "#212e3f" })
vim.api.nvim_set_hl(0, "MiniTablineTabpagesection", { bg = "#192330", bold = true, fg = "#cdcecf" })
vim.api.nvim_set_hl(0, "MiniTablineVisible", { bg = "#212e3f", fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "MiniTestEmphasis", { bold = true })
vim.api.nvim_set_hl(0, "MiniTestFail", { bold = true, fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "MiniTestPass", { bold = true, fg = "#81b29a" })
vim.api.nvim_set_hl(0, "MiniTrailspace", { bg = "#c94f6d" })
...
vim.api.nvim_set_hl(0, "NeoTreeSymbolicLinkTarget", { fg = "#b567b2" })
...
vim.api.nvim_set_hl(0, "NeogitDiffContextHighlight", { bg = "#212e3f" })
vim.api.nvim_set_hl(0, "NeogitDiffDelete", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteHighlight", { bg = "#2e2736" })
...
vim.api.nvim_set_hl(0, "NeotestAdapterName", { bold = true, fg = "#d67ad2" })
vim.api.nvim_set_hl(0, "NeotestDir", { fg = "#63cdcf" })
vim.api.nvim_set_hl(0, "NeotestExpandMarker", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestFailed", { fg = "#c94f6d" })
vim.api.nvim_set_hl(0, "NeotestFile", { fg = "#719cd6" })
vim.api.nvim_set_hl(0, "NeotestFocused", { underline = true })
vim.api.nvim_set_hl(0, "NeotestIndent", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestMarked", { bold = true, fg = "#cdcecf" })
vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = "#54aeb0" })
vim.api.nvim_set_hl(0, "NeotestPassed", { fg = "#81b29a" })
vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#f4a261" })
vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#dbc074" })
...
vim.api.nvim_set_hl(0, "NotifyINFOBorder", { fg = "#455f83" })
...
vim.api.nvim_set_hl(0, "NvimTreeOpenedFile", { fg = "#dc8dd8" })
...
vim.api.nvim_set_hl(0, "NvimTreeSymlink", { fg = "#b567b2" })
...
vim.api.nvim_set_hl(0, "PreProc", { fg = "#dc8dd8" })
...
vim.api.nvim_set_hl(0, "SpellBad", { sp = "#c94f6d", undercurl = true })
vim.api.nvim_set_hl(0, "SpellCap", { sp = "#dbc074", undercurl = true })
vim.api.nvim_set_hl(0, "SpellLocal", { sp = "#719cd6", undercurl = true })
vim.api.nvim_set_hl(0, "SpellRare", { sp = "#719cd6", undercurl = true })
...
vim.api.nvim_set_hl(0, "TabLine", { bg = "#212e3f", fg = "#aeafb0" })
vim.api.nvim_set_hl(0, "TabLineFill", { bg = "#131a24" })
vim.api.nvim_set_hl(0, "TabLineSel", { bg = "#71839b", fg = "#192330" })
...
vim.api.nvim_set_hl(0, "VertSplit", { fg = "#131a24" })
...
vim.api.nvim_set_hl(0, "diffIndexLine", { fg = "#dc8dd8" })
