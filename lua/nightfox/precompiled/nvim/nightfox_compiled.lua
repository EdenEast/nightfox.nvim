...
vim.api.nvim_set_hl(0, "CmpDocumentationBorder", { bg = "#131a24", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "IncSearch", { bg = "#81b29a", fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "LspSagaFinderSelection", { fg = "#ffffff" })
...
vim.api.nvim_set_hl(0, "NeogitHunkHeaderHighlight", { bg = "#ffffff", fg = "#719cd6" })
...
vim.api.nvim_set_hl(0, "Pmenu", { bg = "#ffffff", fg = "#cdcecf" })
...
vim.api.nvim_set_hl(0, "PounceGap", { bg = "#ffffff", fg = "#cdcecf" })
...
vim.api.nvim_set_hl(0, "SneakScope", { bg = "#ffffff" })
