...
vim.api.nvim_set_hl(0, "BufferInactive", { bg = "#131a24", fg = "#5d6e85" })
vim.api.nvim_set_hl(0, "BufferInactiveIndex", { bg = "#131a24", fg = "#5d6e85" })
...
vim.api.nvim_set_hl(0, "Comment", { fg = "#5d6e85" })
...
vim.api.nvim_set_hl(0, "DapUIBreakpointsDisabledLine", { fg = "#5d6e85" })
...
vim.api.nvim_set_hl(0, "HopUnmatched", { fg = "#5d6e85" })
...
vim.api.nvim_set_hl(0, "LightspeedGreyWash", { fg = "#5d6e85" })
vim.api.nvim_set_hl(0, "LineNr", { fg = "#71839b" })
vim.api.nvim_set_hl(0, "LspCodeLens", { fg = "#5d6e85" })
...
vim.api.nvim_set_hl(0, "NeoTreeGitIgnored", { fg = "#5d6e85" })
...
vim.api.nvim_set_hl(0, "NotifyTRACETitle", { fg = "#5d6e85" })
