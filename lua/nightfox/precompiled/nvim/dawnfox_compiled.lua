...
vim.api.nvim_set_hl(0, "@tag.javascript", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@tag.typescript", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@text", { fg = "#575279" })
...
vim.api.nvim_set_hl(0, "NvimTreeImageFile", { fg = "#5f5695" })
