...
vim.api.nvim_set_hl(0, "@constant.builtin", { fg = "#ca6e69" })
vim.api.nvim_set_hl(0, "@constructor", { fg = "#907aa9" })
vim.api.nvim_set_hl(0, "@danger", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@error", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@field", { fg = "#286983" })
vim.api.nvim_set_hl(0, "@field.rust", { fg = "#625c87" })
vim.api.nvim_set_hl(0, "@function.builtin", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@function.macro", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@keyword.function", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@keyword.operator", { bold = true, fg = "#625c87" })
vim.api.nvim_set_hl(0, "@namespace", { fg = "#50848c" })
vim.api.nvim_set_hl(0, "@note", { fg = "#286983" })
vim.api.nvim_set_hl(0, "@operator", { fg = "#625c87" })
vim.api.nvim_set_hl(0, "@property", { link = "@field" })
vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = "#625c87" })
vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = "#625c87" })
vim.api.nvim_set_hl(0, "@punctuation.special", { fg = "#625c87" })
vim.api.nvim_set_hl(0, "@string.escape", { bold = true, fg = "#dd9024" })
vim.api.nvim_set_hl(0, "@string.regex", { fg = "#dd9024" })
...
vim.api.nvim_set_hl(0, "@text.reference", { fg = "#907aa9" })
vim.api.nvim_set_hl(0, "@type.builtin", { fg = "#50848c" })
vim.api.nvim_set_hl(0, "@uri", { bold = true, fg = "#56949f" })
vim.api.nvim_set_hl(0, "@variable", { fg = "#575279" })
vim.api.nvim_set_hl(0, "@variable.builtin", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "@warning", { fg = "#ea9d34" })
...
vim.api.nvim_set_hl(0, "BufferInactiveMod", { bg = "#ebe5df", fg = "#f5d9b5" })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo", { sp = "#286983", undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { sp = "#ea9d34", undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextError", { bg = "#e5c8ca", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextHint", { bg = "#ccd3c8", fg = "#618774" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextInfo", { bg = "#bbcacd", fg = "#286983" })
vim.api.nvim_set_hl(0, "DiagnosticVirtualTextWarn", { bg = "#f5d9b5", fg = "#ea9d34" })
vim.api.nvim_set_hl(0, "DiagnosticWarn", { fg = "#ea9d34" })
vim.api.nvim_set_hl(0, "DiffAdd", { bg = "#dbded4" })
vim.api.nvim_set_hl(0, "DiffChange", { bg = "#d0d8d7" })
vim.api.nvim_set_hl(0, "DiffDelete", { bg = "#ebd7d6" })
vim.api.nvim_set_hl(0, "DiffText", { bg = "#a5bcc2" })
...
vim.api.nvim_set_hl(0, "IncSearch", { bg = "#618774", fg = "#FFFFFF" })
...
vim.api.nvim_set_hl(0, "MiniJump", { bg = "#907aa9", fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniJump2dSpot", { bold = true, fg = "#56949f" })
vim.api.nvim_set_hl(0, "MiniStarterCurrent", { nocombine = true })
vim.api.nvim_set_hl(0, "MiniStarterFooter", { fg = "#ca6e69", italic = true })
...
vim.api.nvim_set_hl(0, "MiniStarterItemBullet", { fg = "#a8a3b3" })
vim.api.nvim_set_hl(0, "MiniStarterItemPrefix", { fg = "#d685af" })
vim.api.nvim_set_hl(0, "MiniStarterQuery", { fg = "#618774" })
vim.api.nvim_set_hl(0, "MiniStarterSection", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "MiniStatuslineDevinfo", { bg = "#ebe0df", fg = "#625c87" })
vim.api.nvim_set_hl(0, "MiniStatuslineFileinfo", { bg = "#ebe0df", fg = "#625c87" })
...
vim.api.nvim_set_hl(0, "MiniStatuslineModeCommand", { bg = "#ea9d34", bold = true, fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeInsert", { bg = "#618774", bold = true, fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeNormal", { bg = "#56949f", bold = true, fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeOther", { bg = "#286983", bold = true, fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeReplace", { bg = "#b4637a", bold = true, fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniStatuslineModeVisual", { bg = "#907aa9", bold = true, fg = "#ebe5df" })
vim.api.nvim_set_hl(0, "MiniSurround", { link = "IncSearch" })
vim.api.nvim_set_hl(0, "MiniTablineCurrent", { bg = "#bdbfc9", bold = true, fg = "#625c87" })
vim.api.nvim_set_hl(0, "MiniTablineFill", { link = "TabLineFill" })
vim.api.nvim_set_hl(0, "MiniTablineHidden", { bg = "#ebe0df", fg = "#a8a3b3" })
vim.api.nvim_set_hl(0, "MiniTablineModifiedCurrent", { bg = "#625c87", bold = true, fg = "#bdbfc9" })
vim.api.nvim_set_hl(0, "MiniTablineModifiedHidden", { bg = "#a8a3b3", fg = "#ebe0df" })
vim.api.nvim_set_hl(0, "MiniTablineModifiedVisible", { bg = "#625c87", fg = "#ebe0df" })
vim.api.nvim_set_hl(0, "MiniTablineTabpagesection", { bg = "#faf4ed", bold = true, fg = "#575279" })
vim.api.nvim_set_hl(0, "MiniTablineVisible", { bg = "#ebe0df", fg = "#625c87" })
vim.api.nvim_set_hl(0, "MiniTestEmphasis", { bold = true })
vim.api.nvim_set_hl(0, "MiniTestFail", { bold = true, fg = "#b4637a" })
vim.api.nvim_set_hl(0, "MiniTestPass", { bold = true, fg = "#618774" })
vim.api.nvim_set_hl(0, "MiniTrailspace", { bg = "#b4637a" })
...
vim.api.nvim_set_hl(0, "NeogitDiffAddHighlight", { bg = "#dbded4" })
vim.api.nvim_set_hl(0, "NeogitDiffContextHighlight", { bg = "#ebe0df" })
vim.api.nvim_set_hl(0, "NeogitDiffDelete", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "NeogitDiffDeleteHighlight", { bg = "#ebd7d6" })
...
vim.api.nvim_set_hl(0, "NeotestAdapterName", { bold = true, fg = "#d685af" })
vim.api.nvim_set_hl(0, "NeotestDir", { fg = "#56949f" })
vim.api.nvim_set_hl(0, "NeotestExpandMarker", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestFailed", { fg = "#b4637a" })
vim.api.nvim_set_hl(0, "NeotestFile", { fg = "#286983" })
vim.api.nvim_set_hl(0, "NeotestFocused", { underline = true })
vim.api.nvim_set_hl(0, "NeotestIndent", { link = "Conceal" })
vim.api.nvim_set_hl(0, "NeotestMarked", { bold = true, fg = "#575279" })
vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = "#50848c" })
vim.api.nvim_set_hl(0, "NeotestPassed", { fg = "#618774" })
vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#d7827e" })
vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#ea9d34" })
...
vim.api.nvim_set_hl(0, "SpellCap", { sp = "#ea9d34", undercurl = true })
vim.api.nvim_set_hl(0, "SpellLocal", { sp = "#286983", undercurl = true })
...
vim.api.nvim_set_hl(0, "TabLine", { bg = "#ebe0df", fg = "#625c87" })
vim.api.nvim_set_hl(0, "TabLineFill", { bg = "#ebe5df" })
vim.api.nvim_set_hl(0, "TabLineSel", { bg = "#a8a3b3", fg = "#faf4ed" })
...
vim.api.nvim_set_hl(0, "VertSplit", { fg = "#ebe5df" })
