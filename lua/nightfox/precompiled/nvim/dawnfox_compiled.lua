...
vim.api.nvim_set_hl(0, "BufferLineBackground", { bg = "#ebe5df", fg = "#9893a5" })
vim.api.nvim_set_hl(0, "BufferLineBufferSelected", { bg = "#faf4ed", fg = "#4c4769" })
vim.api.nvim_set_hl(0, "BufferLineBufferVisible", { bg = "#ebe5df", fg = "#575279" })
vim.api.nvim_set_hl(0, "BufferLineCloseButton", { bg = "#ebe5df", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonSelected", { bg = "#faf4ed", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "BufferLineCloseButtonVisible", { bg = "#ebe5df", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "BufferLineError", { bg = "#b4637a", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "BufferLineErrorDiagnostic", { bg = "#b4637a", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "BufferLineFill", { bg = "#ebe5df" })
vim.api.nvim_set_hl(0, "BufferLineIndicatorSelected", { bg = "#faf4ed", fg = "#faf4ed" })
vim.api.nvim_set_hl(0, "BufferLineModified", { bg = "#ebe5df", fg = "#618774" })
vim.api.nvim_set_hl(0, "BufferLineModifiedSelected", { bg = "#faf4ed", fg = "#618774" })
vim.api.nvim_set_hl(0, "BufferLineModifiedVisible", { bg = "#ebe5df", fg = "#618774" })
vim.api.nvim_set_hl(0, "BufferLineSeparator", { bg = "#ebe5df", fg = "#286983" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorSelected", { bg = "#faf4ed", fg = "#286983" })
vim.api.nvim_set_hl(0, "BufferLineSeparatorVisible", { bg = "#ebe5df", fg = "#286983" })
vim.api.nvim_set_hl(0, "BufferLineTab", { bg = "#ebe5df", fg = "#ebdfe4" })
vim.api.nvim_set_hl(0, "BufferLineTabClose", { bg = "#ebe5df", fg = "#b4637a" })
vim.api.nvim_set_hl(0, "BufferLineTabSelected", { bg = "#ebe5df", fg = "#ebe5df" })
